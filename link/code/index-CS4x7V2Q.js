      ...
      <main>
        <div id="welcomeBar">
          ...
          <sl-card id="infoCard">
            ...
            <ul>
              <li>
                <a href="https://www.typescriptlang.org/">TypeScript</a> - 类型安全的JavaScript
              </li>

              <li>
                <a href="https://lit.dev">Lit</a> - 轻量级Web组件库
              </li>

              <li>
                <a href="https://shoelace.style/">Shoelace</a> - 现代UI组件
              </li>

              <li>
                <a href="https://github.com/thepassle/app-tools/blob/master/router/README.md"
                  >App Tools Router</a> - 路由管理
              </li>
            </ul>
          </sl-card>
